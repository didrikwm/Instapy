...
@jit(nopython=True)
def numba_color2sepia(image, amount=None):
    """Transforms an image to a sepia version using solely Python code, and Numba.

    Args:
        filename (string): A string representing the filename of the image to be transformed.
